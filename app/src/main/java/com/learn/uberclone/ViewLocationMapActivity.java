...
public class ViewLocationMapActivity extends FragmentActivity implements OnMapReadyCallback, View.OnClickListener {
    ...
    private Button btnViewLocationMap_GiveRide;
    ...
    private void assignUI() {
        btnViewLocationMap_GiveRide = findViewById(R.id.btnViewLocationMap_GiveRide);
        btnViewLocationMap_GiveRide.setText("I want to give " + getIntent().getStringExtra("rUsername") + " a ride");
    }
    ...
    private void callAllClickEvent() {
        btnViewLocationMap_GiveRide.setOnClickListener(this);
    }

    @Override
    public void onClick(View view) {
        switch (view.getId()) {
            case (R.id.btnViewLocationMap_GiveRide) :
                                        ...
                                        public void done(ParseException e) {
                                            if (e == null) {
                                                Intent googleIntent = new Intent(Intent.ACTION_VIEW,
                                                        Uri.parse("http://maps.google.com/maps?saddr=" + getIntent().getDoubleExtra("dLatitude", 0) + "," + getIntent().getDoubleExtra("dLongitude", 0) + "&" + "daddr=" + getIntent().getDoubleExtra("pLatitude", 0) + "," + getIntent().getDoubleExtra("pLongitude", 0)));
